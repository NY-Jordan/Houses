...
<div class="col-12 col-md-4 d-none d-lg-block">
    <div class="card border-light p-2">
        <div class="card-body p-2">
            <div class="profile-thumbnail small-thumbnail mx-auto"><a href="{{ asset('assets/img/profile-picture-4.jpg') }}" class="elv-zoom"
                data-fancybox-group="gallery" title="Title Here"><img src="{{ asset('assets/img/profile-picture-4.jpg') }}" class="card-img-top rounded-circle border-white" alt="Joseph Portrait" /> </a> </div>
            ...
            <div class="list-group dashboard-menu list-group-sm mt-4">
                ...
                <a href="payments.html" class="d-flex list-group-item list-group-item-action">
                    Payments<span class="icon icon-xs ml-auto"><span class="fas fa-chevron-right"></span></span>
                </a>
                <a href="profile.html" class="d-flex list-group-item list-group-item-action">
