...
<div class="col-12 col-lg-8">
    ...
    <div class="row">
        <div class="col-4" style="font-size: 20px">Balance : {{ $balance }}
            {{ 'Point' }}@if ($balance > 1){{ 's' }}@endif
        </div>
        <div class="col-4"></div>
        <div class="col-md-4 col-sm-4 mb-4">
            <button class="btn btn-primary" data-toggle="modal" data-target="#points" type="button">+ Get points</button>
        </div>
    </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="badge badge-{{$transaction->badge}}">{{ $transaction->status }}</p>
                            </td>
                            <td>
